...
// display employees details based on department such as the 
// HR department. Include the given code below after the previous
// JavaScript code.
...
// function to display employees' details based on ID. Include the
// below given code after the previous JavaScript code.
...
function findBySpecialization(employeeSpecialization) {
    ...
    if (foundSpecialization) {
        document.getElementById('employeesDetails').innerHTML = `<p>${foundSpecialization.id}: ${foundSpecialization.name} - ${foundSpecialization.department} - $${foundSpecialization.salary} - ${foundSpecialization.specialization}</p>`
    }
    else {
